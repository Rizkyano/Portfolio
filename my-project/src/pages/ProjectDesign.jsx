...
import DesignProject from "../containers/Project/desginProject";
        ...
        <div className="relative isolate px-6 pt-20 lg:px-8">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="text-center mb-12">
            <div className="mx-auto max-w-4xl py-5 sm:py-5 lg:py-5 text-center">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl">Design Projects</h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                A visually striking graphic design portfolio showcasing branding, posters, digital illustrations, and social media content, crafted using Adobe Photoshop, and Illustrator. Features bold compositions, cohesive color theory,
                and responsive layouts to emphasize creativity and visual impact.
              </p>
